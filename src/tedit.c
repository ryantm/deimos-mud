...
ACMD(do_tedit)
{
  ...
  struct {
	...
	{ "news",	LVL_GRGOD,	&news,		8192,	NEWS_FILE},
        { "buildercode",   LVL_IMPL,   &buildercode,   8192,   BUILDERCODE_FILE},
	...
	{ "smartmud",	LVL_IMPL,	&smartmud,	8192,	SMARTMUD_FILE},
	{ "\n",		0,		NULL,		0,	NULL }
  };
