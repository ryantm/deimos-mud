...
#define SPELL_IDENTIFY               52 /* Cast identify, duh...dumbass.. */
#define SPELL_RESURRECTION           53 /* In case some moron dies        */
#define SPELL_REFRESH                54 /* Refreshes movement points      */
#define SPELL_DISPEL_MAGIC           55 /* Dispels magical crap           */
#define SPELL_FIND_TARGET            56 /* Find where a target is ...     */
#define SPELL_INTERPOSING_HANDS      57 /* I don't know what the hell this is */
#define SPELL_FLOAT                  58 /* Float away, another Firrox thing */
#define SPELL_MANASHIELD             59 /* The Cleric Special Spell, DAN  */
#define SPELL_NOVASTORM              60 /* The NovaStorm, the Mage AK     */
#define SPELL_WEB                    61 /* It be webbing yo ass           */
#define SPELL_GATE                   62 /* Gate to another dumbass        */
#define SPELL_DISINTEGRATE           63 /* Fry his lardy ass              */
#define SPELL_HELLFIRE               64 /* Oooooh baby, EXTRA spicy       */
#define SPELL_GREATERHEAL            65 /* It's heal...but greater...     */
#define SPELL_BERSERK                66 /* I'll Berserk You */
#define SPELL_SHROUD                 67 /* Defensive SHROUD BIZNATCH!     */
#define SPELL_DIMPHASE               68 /* YO, dis be el dimension phase  */
#define SPELL_ICEBOLT                69
#define SPELL_SLOW                   70
#define SPELL_SUSTAINANCE            71
#define SPELL_MAGIC_ERASER           72
#define SPELL_MANA                   73
#define SPELL_AUROROUS               74
#define SPELL_GASEOUS                75
#define SPELL_TURKEY                 76
#define SPELL_ARENBURG_RECALL        77

#define TOP_OF_SPELLS                78 
/*This should always be at the top of spells, It can eventually = 130 */
...
#define SKILL_WEAPON_DAGGERS        144
#define SKILL_WEAPON_WHIPS          145
#define SKILL_WEAPON_TALONOUS_ARMS  146
#define SKILL_WEAPON_BLUDGEONS      147
#define SKILL_WEAPON_EXOTICS        148
#define SKILL_BANDAGE               149
#define SKILL_STAB                  150
#define SKILL_SHOOT                 151
#define SKILL_TETHER                152
#define SKILL_WHIRLWIND             153
#define SKILL_TRIP                  154
#define SKILL_SHADE                 155
#define SKILL_MP_REGEN              156
#define SKILL_HP_REGEN              157
#define SKILL_MV_REGEN              158
#define SKILL_DOUBLE_STAB           159
#define SKILL_SPELL_MASTERY         160
#define SKILL_MULTI_ATTACK          161
#define SKILL_SEE_INV               162
#define SKILL_HALF_MANA             163
...
ASPELL(spell_interposing_hands);
ASPELL(spell_gate);
...
void spell_levelw(int spell, int chclass, int levelwarrior, int multi, int power);
