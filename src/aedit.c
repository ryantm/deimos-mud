...
"$N char name target of social (other person's name)\r\n"
...
void aedit_parse(struct descriptor_data * d, char *arg) {
   ...
   aedit_save_to_disk(d);
	 send_to_char("Action saved to disk.\r\n", d->character);
	 break;
       case 'n': case 'N':
   ...
   aedit_disp_positions(d);
	 ...
	 break;
       case 'a': case 'A':
	 sprintf(buf, "%sEnter social shown to the Character when there is no argument supplied.\r\n[OLD]: %s\r\n[NEW]: ",
     aedit_var_list,
	 ...
	 return;
       case 'b': case 'B':
	 sprintf(buf, "%sEnter social shown to Others when there is no argument supplied.\r\n[OLD]: %s\r\n[NEW]: ",
     aedit_var_list,
	 ...
	 return;
       case 'c': case 'C':
	 sprintf(buf, "%sEnter text shown to the Character when his victim isnt found.\r\n[OLD]: %s\r\n[NEW]: ",
     aedit_var_list,
	 ...
	 return;
       case 'd': case 'D':
	 sprintf(buf, "%sEnter social shown to the Character when it is its own victim.\r\n[OLD]: %s\r\n[NEW]: ",
     aedit_var_list,
	 ...
	 return;
       case 'e': case 'E':
	 sprintf(buf, "%sEnter social shown to Others when the Char is its own victim.\r\n[OLD]: %s\r\n[NEW]: ",
     aedit_var_list,
	 ...
	 return;
       case 'f': case 'F':
	 sprintf(buf, "%sEnter normal social shown to the Character when the victim is found.\r\n[OLD]: %s\r\n[NEW]: ",
     aedit_var_list,
	 ...
	 return;
       case 'g': case 'G':
	 sprintf(buf, "%sEnter normal social shown to Others when the victim is found.\r\n[OLD]: %s\r\n[NEW]: ",
     aedit_var_list,
	 ...
	 return;
       case 'h': case 'H':
	 sprintf(buf, "%sEnter normal social shown to the Victim when the victim is found.\r\n[OLD]: %s\r\n[NEW]: ",
     aedit_var_list,
	 ...
	 return;
       case 'i': case 'I':
	 sprintf(buf, "%sEnter 'body part' social shown to the Character when the victim is found.\r\n[OLD]: %s\r\n[NEW]: ",
     aedit_var_list,
	 ...
	 return;
       case 'j': case 'J':
	 sprintf(buf, "%sEnter 'body part' social shown to Others when the victim is found.\r\n[OLD]: %s\r\n[NEW]: ",
     aedit_var_list,
	 ...
	 return;
       case 'k': case 'K':
	 sprintf(buf, "%sEnter 'body part' social shown to the Victim when the victim is found.\r\n[OLD]: %s\r\n[NEW]: ",
     aedit_var_list,
	 ...
	 return;
       case 'l': case 'L':
	 sprintf(buf, "%sEnter 'object' social shown to the Character when the object is found.\r\n[OLD]: %s\r\n[NEW]: ",
     aedit_var_list,
	 ...
	 return;
       case 'm': case 'M':
	 sprintf(buf, "%sEnter 'object' social shown to the Room when the object is found.\r\n[OLD]: %s\r\n[NEW]: ",
     aedit_var_list,
